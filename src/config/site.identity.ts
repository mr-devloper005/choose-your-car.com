export const siteIdentity = {
  ...
  tagline: process.env.NEXT_PUBLIC_SITE_TAGLINE || 'Marketplace discovery platform',
  description:
    process.env.NEXT_PUBLIC_SITE_DESCRIPTION ||
    'A utility-first platform for business listings, local opportunities, and classified discovery.',
