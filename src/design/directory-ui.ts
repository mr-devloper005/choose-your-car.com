...
const presets: Record<string, DirectoryUiPreset> = {
  ...
  'choose-your-car.com': {
    ...
    cardFrame: 'group grid h-full overflow-hidden rounded-[5px] border border-[#0f172a]/12 bg-white shadow-[0_12px_32px_rgba(15,23,42,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_46px_rgba(15,23,42,0.13)] 2xl:grid-cols-[240px_1fr]',
    cardImage: 'aspect-[16/10] 2xl:aspect-auto 2xl:min-h-[210px]',
